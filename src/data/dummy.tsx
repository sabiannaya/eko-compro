...
export const facilitiesData = [
  {
    id: "fac-1", // ID ditambahkan
    title: "Elementary School",
    facilities: [
      {
        id: "fac-1-sub-1", // ID ditambahkan untuk sub-item
        content:
          "Comprehensive study guides and modules for Science, Mathematics, Indonesian Language, and Thematic learning",
        image: "/Logo.png",
      },
      {
        id: "fac-1-sub-2", // ID ditambahkan untuk sub-item
        content:
  ...
  {
    id: "fac-2", // ID ditambahkan
    title: "Junior High School",
    facilities: [
      {
        id: "fac-2-sub-1", // ID ditambahkan untuk sub-item
        content:
          "Detailed study modules for Science, Mathematics, Indonesian Language, and English",
        image: "/Logo.png",
      },
      {
        id: "fac-2-sub-2", // ID ditambahkan untuk sub-item
        content:
      ...
      {
        id: "fac-2-sub-3", // ID ditambahkan untuk sub-item
        content:
  ...
  {
    id: "fac-3", // ID ditambahkan
    title: "Senior High School",
    facilities: [
      {
        id: "fac-3-sub-1", // ID ditambahkan untuk sub-item
        content:

...
export const programData: ProgramInterface[] = [
  ...
  },
  {
    ...
    description: {
      ...
      id: "Program ini dirancang khusus untuk membantumu mengukur dan meningkatkan kemampuan secara berkala yang dilakukan setiap bulannya, memastikan kamu selalu berada di jalur yang tepat menuju kesuksesan.",
    },
    thumbnail: "/Logo.png",
  },
  {
